...
#sudo cp debian_container_dotfiles/etc/apt/* /etc/apt
...
mkdir -p ~/.config
cp debian_container_dotfiles/dotspacemacs ~/.spacemacs
cp debian_container_dotfiles/dotbashrc ~/.bashrc
cp debian_container_dotfiles/dotvimrc ~/.vimrc
cp debian_container_dotfiles/dotxbindkeysrc ~/.xbindkeysrc
